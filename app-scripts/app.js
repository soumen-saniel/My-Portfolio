		...
		$(".rslides").responsiveSlides({
      	...
      	$(window).load(function() {
		    $('.skills-flexslider').flexslider({
				...
				manualControls: ".skills-flexslider-controls a",             //Selector: Declare custom control navigation. Examples would be ".flex-control-nav li" or "#tabs-nav li img", etc. The number of elements in your controlNav should match the number of slides/tabs.
